...
# Dashboard - Antigravity Instructions

## Project Overview

This is a Next.js App Router-based Dashboard platform. The codebase uses TypeScript, React, TailwindCSS, shadcn/ui, and TanStack Query for state management and data fetching.
